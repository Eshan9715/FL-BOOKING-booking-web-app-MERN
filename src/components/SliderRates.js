...
const SliderRates= ({discharge,containers,shipmode, validPeriod, shippingline}) => {
        ...
        <div className='flex items-center bg-white rounded-lg p-5'>
          <div className='w-full flex justify-center items-start flex-col'>
            <div className='w-full flex justify-between items-center'>
              ...
              <div className='flex justify-center items-center gap-3'>
              <h4 className='font-semibold text-xs text-slate-400'>Until: <span className='text-sm text-black ml-2'> {day}</span></h4>
              </div>
