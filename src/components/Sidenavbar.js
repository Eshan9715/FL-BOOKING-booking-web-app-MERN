...
const Sidenavbar = ({role}) => {
    ...
    const tags = [
        { 
            ...
            val: "Dashboard",
            link:"/dashboard",
            role: ["Shipper","SalesMan", "CRD", "RatesManager","Top admin"],
        ...
        { 
            ...
            val: "Bookings",
            link:'/bookings',
            role: ["Shipper","SalesMan", "CRD","Top admin"],
            icon: <svg fill="none" stroke="currentColor" className="w-6 h-6 rtl:-scale-x-100" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        { 
          ...
          val: "Mails",
          link:'/createmail',
          role:["Shipper","SalesMan", "CRD","Top admin","RatesManager"],
          icon: <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" className="w-6 h-6 rtl:-scale-x-100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  return (
    <div className='flex min-h-screen w-20  md:w-48 fixed bg-slate-200 justify-center items-center z-40'>
        <div className='flex flex-col h-[80%] w-full justify-center items-center mt-16'>
            ...
            <div className={` flex justify-center  shadow:md  items-center p-3 gap-3 m-2 text-center `}  key={tag.id}>
                {tag.icon}
                <p className='hidden md:flex text-base text-start justify-start w-1/2'>{tag.val}</p> 
            </div>
            </NavLink>
        ))}
