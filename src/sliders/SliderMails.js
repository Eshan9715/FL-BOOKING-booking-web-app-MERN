  ...
  return (
    <>
      ...
      <div className='flex items-center justify-center flex-col'>
        ...
        <Swiper className='w-full h-[205px] flex flex-col items-center justify-center mt-3 gap-4 mb-5'
        ...
        //   }}
          ...
          {data.map(obj=>(
              ...
              <div className="w-full flex px-3 py-2.5 bg-white shadow-md hover:shodow-lg rounded-lg mt-5" key={obj.id}>
